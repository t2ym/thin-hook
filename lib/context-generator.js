...
module.exports = function (hook) {
  ...
  function generateCachedMethodContext(astPath) {
    let result;
    let i;
  ...
  function generateCachedMethodDebugContext(astPath) {
    let method = generateMethodContext(astPath);
    let result = generateCachedMethodContext(astPath);
    if (result !== method) {
  ...
  return {
    contextGenerators: {
      ...
      'cachedMethod': generateCachedMethodContext,
