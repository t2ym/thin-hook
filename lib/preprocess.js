    ...
    case 'VariableDeclaration':
      if (_hookProperty && _hookGlobal &&
        ...
        if (ast.__for__ &&
          ...
          ast.declarations[0].id.type === 'Identifier' &&
          !ast.declarations[0].init &&
          !blockScope[ast.declarations[0].id.name]) {
          ...
          template.object.arguments[3].value = ast.kind;
          ...
          template.property.name = _hookPrefix + body.name;
