...
module.exports = function(espree, escodegen, htmlparser, createHash, convert) {
  ...
  function _preprocess(ast, isConstructor = false, hookName, astPath, contextGeneratorName, contextGenerator, metaHooking, _hookProperty, _sourceMap, _hookGlobal, _hookPrefix, blockScope, functionScope, globalScope, globalObjectScope, globalClassScope){
        ...
        template = _espreeParse(t
          ? ast.generator
            ...
            : isConstructor
              ...
              : 'function f(...args) { return _X_hookName_X_(() => {}, this, args, \'X_X_XcontextX_X_X\'); }'
          : ast.generator
            ...
            : isConstructor
              ...
              : 'function f() { return _X_hookName_X_(() => {}, this, arguments, \'X_X_XcontextX_X_X\'); }',
          hookName, context);
        f = ast.generator
    ...
    case 'CallExpression':
      if (ast.__hooked__) {
        ...
        if (ast.callee.type === 'Super') {
          ...
          context = contextGenerator(astPath).replace(/\'/g, '\\\'');
          template = _espreeParse('_X_hookName_X_(f, this, [], \'X_X_XcontextX_X_X\', 0)', hookName, context);
          f = template.expression;
          f.arguments[0] = ast.callee;
          f.arguments[2].elements = ast.arguments;
          f.__hooked__ = true;
        ...
        if (Array.isArray(child)) {
          for (t = child, index = 0, l = t.length; index < l; index++) {
            ...
            if (item && typeof item === 'object' && typeof item.type === 'string') {
              ...
              _preprocess(item, false, hookName, astPath, contextGeneratorName, contextGenerator, metaHooking, _hookProperty, _sourceMap, _hookGlobal, _hookPrefix, blockScope, functionScope, globalScope, globalObjectScope, globalClassScope);
              astPath.pop();
            }
          }
        }
        else if (typeof child === 'object' && typeof child.type === 'string') {
          _preprocess(child, isConstructor, hookName, astPath, contextGeneratorName, contextGenerator, metaHooking, _hookProperty, _sourceMap, _hookGlobal, _hookPrefix, blockScope, functionScope, globalScope, globalObjectScope, globalClassScope);
        }
        astPath.pop();
      }
    }
  ...
  function hook(code, hookName = '__hook__', initialContext = [], contextGeneratorName = 'method', metaHooking = true, _hookProperty = getHookProperty(), _sourceMap = null, asynchronous = false, _compact = getCompact(), _hookGlobal = getHookGlobal(), _hookPrefix = getHookPrefix(), initialScope = null) {
    if (asynchronous) {
      ...
      _preprocess(targetAst, false, hookName, initialContext, contextGeneratorName, contextGenerator, metaHooking, _hookProperty, _sourceMap, _hookGlobal, _hookPrefix, blockScope, functionScope, globalScope, globalObjectScope, globalClassScope);
      //_logScope(targetAst);
