...
module.exports = function(espree, escodegen, htmlparser, createHash, convert) {
  ...
  function _nonGlobalWithScope(blockScope, globalScope, hookWith) {
    let o = blockScope;
    let list = {};
    if (o && o !== globalScope && o.hasOwnProperty(hookWith)) {
      o = Object.getPrototypeOf(o);
      while (o && o !== globalScope) {
        Object.assign(list, o);
  ...
  function _preprocess(ast, hookName, astPath, contextGeneratorName, contextGenerator, metaHooking, _hookProperty, _sourceMap, _hookGlobal, _hookPrefix, hookWith, blockScope, functionScope, globalScope, globalObjectScope, globalClassScope){
      ...
      if (_hookProperty && ast.id && typeof ast.id === 'object') {
        if (ast.init) {
          if (ast.init.type === 'Identifier' && ast.init.name) {
            if (hookWith && Object.getPrototypeOf(blockScope)[hookWith]) {
      ...
      if (ast.__hooked__) {
        ...
        case 'Identifier':
          if (hookWith && Object.getPrototypeOf(blockScope)[hookWith]) {
            context = contextGenerator(astPath).replace(/\'/g, '\\\'');
            template = _espreeParse(
              '_X_hookName_X_(\'op\', ' + hookWith + ', [\'p\', () => foo++], \'X_X_XcontextX_X_X\', false)',
              hookName, context);
            f = template.expression;
            params = f.arguments[2].elements;
        ...
        case 'Identifier':
          ...
          case 'delete':
            if (hookWith && Object.getPrototypeOf(blockScope)[hookWith]) {
              context = contextGenerator(astPath).replace(/\'/g, '\\\'');
              template = _espreeParse(
                '_X_hookName_X_(\'wdelete\', ' + hookWith + ', [\'p\', () => delete p], \'X_X_XcontextX_X_X\', false)',
                hookName, context);
              f = template.expression;
              params = f.arguments[2].elements;
              f.arguments[1].__hooked__ = true;
          ...
          case 'typeof':
            if (hookWith && Object.getPrototypeOf(blockScope)[hookWith]) {
              context = contextGenerator(astPath).replace(/\'/g, '\\\'');
              template = _espreeParse(
                '_X_hookName_X_(\'wtypeof\', ' + hookWith + ', [\'p\', () => typeof p], \'X_X_XcontextX_X_X\', false)',
                hookName, context);
              f = template.expression;
              params = f.arguments[2].elements;
              f.arguments[1].__hooked__ = true;
    ...
    case 'AssignmentExpression':
      if (ast.__hooked__) {
        ...
        if (ast.right.type === 'Identifier') {
          if (hookWith && blockScope[hookWith] && !blockScope.hasOwnProperty(hookWith)) {
        ...
        case 'Identifier':
          if (hookWith && blockScope[hookWith] && !blockScope.hasOwnProperty(hookWith)) {
            context = contextGenerator(astPath).replace(/\'/g, '\\\'');
            template = _espreeParse(
              '_X_hookName_X_(\'op\', ' + hookWith + ', [\'p\', v, (v) => p = v], \'X_X_XcontextX_X_X\', false)',
              hookName, context);
            f = template.expression;
            params = f.arguments[2].elements;
      ...
      if (ast.__hooked__) {
        ...
        if (hookWith && Object.getPrototypeOf(blockScope)[hookWith]) {
          if (ast.callee.type === 'Identifier') {
            context = contextGenerator(astPath).replace(/\'/g, '\\\'');
            template = _espreeParse(
              '_X_hookName_X_(\'wnew\', ' + hookWith + ', [\'p\', [], (...args) => new p(...args)], \'X_X_XcontextX_X_X\', false)',
              hookName, context);
            f = template.expression;
            params = f.arguments[2].elements;
          ...
          if (!isInitialImportScripts) {
            if (hookWith && Object.getPrototypeOf(blockScope)[hookWith]) {
              if (ast.callee.type === 'Identifier') {
                context = contextGenerator(astPath).replace(/\'/g, '\\\'');
                template = _espreeParse(
                  '_X_hookName_X_(\'w()\', ' + hookWith + ', [\'p\', [], (...args) => p(...args)], \'X_X_XcontextX_X_X\', false)',
                  hookName, context);
                f = template.expression;
                params = f.arguments[2].elements;
                params[0].value = ast.callee.name;
      ...
      if (ast.__hooked__) {
        ...
        if (ast.__with__) {
          ...
          case 'get':
            context = contextGenerator(astPath).replace(/\'/g, '\\\'');
            template = _espreeParse(
              '_X_hookName_X_(\'w.\', ' + hookWith + ', [\'p\', () => p], \'X_X_XcontextX_X_X\', false)',
              hookName, context);
            f = template.expression;
            params = f.arguments[2].elements;
          ...
          case 'set':
            context = contextGenerator(astPath).replace(/\'/g, '\\\'');
            template = _espreeParse(
              '_X_hookName_X_(\'w.=\', ' + hookWith + ', [\'p\', { set [\'=\'](v) { p = v; }, get [\'=\']() { return p; } }], \'X_X_XcontextX_X_X\', false)[\'=\']',
              hookName, context);
        ...
        if (hookWith && Object.getPrototypeOf(blockScope)[hookWith]) {
          for (index = 0, l = ast.elements.length; index < l; index++) {
            if (ast.elements[index]) {
              ...
              case 'Identifier':
                ast.elements[index].__with__ = 'set';
                break;
              default:
                break;
              }
    ...
    case 'Property':
      if (_hookProperty) {
        ...
        if (ast.value && ast.value.type === 'Identifier' && !ast.value.__global__ && ast.value.name) {
          if (hookWith && Object.getPrototypeOf(blockScope)[hookWith]) {
    ...
    case 'ForStatement':
      if (_hookProperty) {
        if (ast.init && ast.init.type === 'Identifier' && ast.init.name) {
          if (hookWith && Object.getPrototypeOf(blockScope)[hookWith]) {
            ast.init.__with__ = 'set';
          }
          else if (_hookGlobal && !blockScope[ast.init.name]) {
            ast.init.__global__ = 'get';
          }
