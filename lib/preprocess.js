...
module.exports = function(espree, escodegen, htmlparser, createHash, convert) {
  ...
  let configurationsJSON = '{"hookNameForServiceWorker":"__hook__","contextGeneratorName":"method","discardHookErrors":true,"hookProperty":true,"compact":false,"noHookAuthorizationPreValidated":[],"contextGeneratorScripts":[]}';
  ...
  function mutateScriptConfigurationsJSON(script, url) {
    if (url.href.match(/\/hook[.]min[.]js/)) {
      let mutatedScript = script.replace(
        /('{"hookNameForServiceWorker":")(__hook__)(","contextGeneratorName":")(method)(","discardHookErrors":)(true)(,"hookProperty":)(true)(,"compact":)(false)(,"noHookAuthorizationPreValidated":\[\],"contextGeneratorScripts":\[\]}')/,
        '$1' + getHookNameForServiceWorker() + '$3' + getContextGeneratorName() + '$5' + getDiscardHookErrors() + '$7' + getHookProperty() + '$9' + getCompact() + '$11');
