...
module.exports = function (hook, preprocess) {
  ...
  function hookFunction(hookName = preprocess.getHookNameForServiceWorker(), initialContext = [['Function', {}]], contextGenerator = preprocess.getContextGeneratorName(), isGenerator = false) {
    let f;
    if (isGenerator) {
