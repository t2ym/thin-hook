...
module.exports = function (hook, preprocess, he) {
  ...
  function hookGlobal(hookCallback, context, name, type) {
    ...
    if (proxyDescriptor) {
      Object.assign(proxyDescriptor.get, { context: context, strictModePrefix: strictModePrefix });
      Object.assign(proxyDescriptor.set, { context: context, strictModePrefix: strictModePrefix });
    }
    else {
      newProxyDescriptor = {
        configurable: false,
        ...
        get: Object.assign(function get() {
          return hookCallback(strictModePrefix + '.', _global, [name], get.context);
        }, { context: context, strictModePrefix: strictModePrefix }),
        set: Object.assign(function set(value) {
          hookCallback(strictModePrefix + '=', _global, [name, value], set.context);
        }, { context: context, strictModePrefix: strictModePrefix }),
      };
    }
