...
module.exports = function (hook, preprocess, he) {
  ...
  function hookGlobal(hookCallback, context, name, type) {
    ...
    proxyDescriptor = Object.getOwnPropertyDescriptor(proxy, wrapperProperty);
    if (!proxyDescriptor) {
      newProxyDescriptor = {
        configurable: false,
        enumerable: false,
        ...
        set: function set(value) {
          return hookCallback(strictModePrefix + '=', _global, [name, value], context);
        },
      };
    }
    ...
    case 'undefined-class':
      ...
      if (newProxyDescriptor) {
        Object.defineProperty(proxy, wrapperProperty, newProxyDescriptor);
      }
      break;
    case 'undefined-set':
      if (strictModePrefix) {
    ...
    case 'undefined-const':
      Object.defineProperty(proxy, wrapperProperty, {
        configurable: false,
        enumerable: false,
        get: function () {
