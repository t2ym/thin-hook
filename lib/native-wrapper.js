        ...
        value: function setAttribute(name, value) {
          ...
          case 'src':
            if (this instanceof _native.HTMLScriptElement) {
              ...
              if (_value) {
                if (_value.trim().startsWith('javascript:')) {
                  // TODO: support javascript: source
                  value = ''; // block iframe source with javascript:
                  return;
                }
              }
            }
  ...
  function hookHTMLIFrameElement(hookName, initialContext = [['HTMLIFrameElement', {}]], contextGenerator) {
    ...
    if (_native.HTMLIFrameElement &&
      ...
      Object.defineProperty(_native.HTMLIFrameElement.prototype, 'src', {
        ...
        set: function (value) {
          if (typeof value === 'string' && value && value.trim().startsWith('javascript:')) {
            // TODO: support javascript: source
            value = ''; // block javascript: source
