...
const Config = {
  ...
  _concurrency: /* @echo concurrency */,//typeof navigator === 'object' ? navigator.hardwareConcurrency : 1,
  get _targetAppHosts() {
    return [...function *() { for (let i = 1; i <= Config._concurrency; i++) yield `https://${i}./* @echo targetAppHost */`; }()];
  },
  get _targetAppPorts() {
    return [ /* @echo targetAppPort */ ];
  },
  ...
  * originGenerator() {
  ...
  get reporterOrigin() {
    return `https:///* @echo reporterHost */:/* @echo reporterPort */`;
  },
  ...
  */
  ...
  get puppeteerLaunchOptions() {
    return {
      ...
      args: [
        // @foreach $OPTION in puppeteerOptionsArgs
        $OPTION,
        // @endfor
      ],
      executablePath: '/* @echo browserExecutablePath */',
    };
  },
}
