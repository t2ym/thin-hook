const __context_mapper__ = $hook$.$(__hook__, [
  '/components/examples/module-import-default-as-local-from-source-then-export-local-as-exported.js',
  '/components/module-name/index.js',
  '/components/module-name/index.js,default'
]);
import * as __context_mapper__module_namespace_0 from '/components/examples/module-import-default-as-local-from-source-then-export-local-as-exported.js';
