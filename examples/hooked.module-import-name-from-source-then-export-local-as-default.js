const __context_mapper__ = $hook$.$(__hook__, [
  '/components/examples/module-import-name-from-source-then-export-local-as-default.js',
  '/components/module-name/index.js',
  '/components/module-name/index.js,localName'
]);
import * as __context_mapper__module_namespace_0 from '/components/examples/module-import-name-from-source-then-export-local-as-default.js';
