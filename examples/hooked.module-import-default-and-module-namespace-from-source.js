const __context_mapper__ = $hook$.$(__hook__, [
  '/components/examples/module-import-default-and-module-namespace-from-source.js',
  '/components/module-name/index.js',
  '/components/module-name/index.js,default'
]);
import * as __context_mapper__module_namespace_0 from '/components/examples/module-import-default-and-module-namespace-from-source.js';
...
import localName, * as namespace from '/components/module-name/index.js';
__hook__('m', localName, [__context_mapper__[2]], __context_mapper__[0], null);
__hook__('m', namespace, [__context_mapper__[1]], __context_mapper__[0], null);
__hook__(() => {
}, null, [
  'export',
