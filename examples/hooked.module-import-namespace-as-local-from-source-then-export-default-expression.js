const __context_mapper__ = $hook$.$(__hook__, [
  '/components/examples/module-import-namespace-as-local-from-source-then-export-default-expression.js',
  '/components/module-name/index.js'
]);
import * as __context_mapper__module_namespace_0 from '/components/examples/module-import-namespace-as-local-from-source-then-export-default-expression.js';
