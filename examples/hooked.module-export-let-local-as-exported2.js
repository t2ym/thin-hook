const __context_mapper__ = $hook$.$(__hook__, [
  '/components/examples/module-export-let-local-as-exported2.js',
  'undefined,undefined'
]);
import * as __context_mapper__module_namespace_0 from '/components/examples/module-export-let-local-as-exported2.js';
let localName = 'value';
export {
  localName as exportedName,
  localName as exportedName2
};
