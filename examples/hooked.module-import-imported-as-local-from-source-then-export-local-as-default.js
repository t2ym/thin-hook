const __context_mapper__ = $hook$.$(__hook__, [
  '/components/examples/module-import-imported-as-local-from-source-then-export-local-as-default.js',
  '/components/module-name/index.js',
  '/components/module-name/index.js,importedName'
]);
import * as __context_mapper__module_namespace_0 from '/components/examples/module-import-imported-as-local-from-source-then-export-local-as-default.js';
