const __context_mapper__ = $hook$.$(__hook__, [
  '/components/examples/module-export-array-rest-local-nested.js',
  '/components/examples/module-export-array-rest-local-nested.js,localName'
]);
import * as __context_mapper__module_namespace_0 from '/components/examples/module-export-array-rest-local-nested.js';
