const __context_mapper__ = $hook$.$(__hook__, [
  '/components/examples/module-export-var-local.js',
  '/components/examples/module-export-var-local.js,localName'
]);
import * as __context_mapper__module_namespace_0 from '/components/examples/module-export-var-local.js';
