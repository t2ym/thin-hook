const __context_mapper__ = $hook$.$(__hook__, [
  '/components/examples/module-import-name-as-local-from-source.js',
  '/components/module-name/index.js',
  '/components/module-name/index.js,importedName'
]);
import * as __context_mapper__module_namespace_0 from '/components/examples/module-import-name-as-local-from-source.js';
