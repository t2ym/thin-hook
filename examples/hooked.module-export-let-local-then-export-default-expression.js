const __context_mapper__ = $hook$.$(__hook__, [
  '/components/examples/module-export-let-local-then-export-default-expression.js',
  '/components/examples/module-export-let-local-then-export-default-expression.js,localName'
]);
import * as __context_mapper__module_namespace_0 from '/components/examples/module-export-let-local-then-export-default-expression.js';
