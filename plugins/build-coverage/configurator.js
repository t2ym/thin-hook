...
const { _trimStartEndRaw } = require('@thin-hook/build/build-helpers.js');

const pluginName = '@thin-hook/build-coverage';

const configurator = function (targetConfig) {
  return () => browserify(path.resolve(this.path.hook, this.path.test, 'coverage/hook.js'), { standalone: 'hook' })
    .plugin(licensify)
    .bundle()
